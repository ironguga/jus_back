...
class DocumentMCPServer:
    ...
    async def process_query(self, query: str) -> str:
        try:
            db_path = Path(__file__).parents[2] / "database" / "banco.db"
            ...
            total, audios, fotos, videos, docs = stats
...
{query}{AI_PROMPT}"""
    ...
    # Os outros métodos podem ficar como placeholders
